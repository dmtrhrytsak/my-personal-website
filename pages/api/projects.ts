...
const projects: IProject[] = [
  ...
  },
  {
    ...
    technologies: ['JS', 'HTML', 'Sass', 'BEM'],
    gitHub: 'https://github.com/dmtrhrytsak/Museum_2/tree/develop',
    preview: 'https://dmtrhrytsak.github.io/Museum_2/',
    color: 'bg-blue-500',
  },
  {
    name: 'Kickstarter | Landing Page',
    technologies: ['JS', 'HTML', 'Sass', 'BEM'],
    gitHub: 'https://github.com/dmtrhrytsak/Kickstarter/tree/develop',
    preview: 'https://dmtrhrytsak.github.io/Kickstarter/',
    color: 'bg-lime-500',
  },
];
